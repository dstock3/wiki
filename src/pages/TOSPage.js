  ...
  return (
    <div className="tos-page">
      ...
      <div className="tos-container">
        ...
        <p>By accessing and using WikiWise ("the Service"), you agree to comply with and be bound by these Terms of Service.</p>
        ...
        <h2>Contact</h2>
        <p>If you have any questions about these Terms, please contact us at <a href="mailto:support@wikiwise.com">support@wikiwise.com</a>.</p>
      </div>
    </div>
  );
};
